...
// Import download worker as an inlined blob – consumers need no bundler config!
import DownloadWorkerConstructor from './download.worker.ts?worker&inline';
...
export class DownloadManager {
  ...
  public onProgress?: (stats: DownloadStats) => void;
  ...
  private startWorker(metadata: FileDownloadMetadata) {
    const worker = new DownloadWorkerConstructor();
